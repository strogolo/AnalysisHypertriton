...
void AliAnalysisTaskHypertriton3::UserExec(Option_t *){
 ...
 //==========MC info==========
  ...
  TArrayI cDeu(ntracks);
  Int_t nDeuTPC = 0;
  TArrayI cPro(ntracks);
  Int_t nProTPC = 0;
  ...
  //vector<AliESDtrack*>().swap(cdeuteron);
  //vector<AliESDtrack*>().swap(cproton);
  //vector<AliESDtrack*>().swap(cpion);
